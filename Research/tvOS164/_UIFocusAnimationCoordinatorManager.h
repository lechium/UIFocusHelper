...
- (void).cxx_destruct;	// IMP=0x00000000005e04a4
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000005e03b7
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000005e02f3
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000005dfd7c
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000005dfbe1
- (id)init;	// IMP=0x00000000005dfb76
