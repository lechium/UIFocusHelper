...
- (void).cxx_destruct;	// IMP=0x000000000062e439
...
- (id)description;	// IMP=0x000000000062e26b
- (void)drawVisualRepresentationInContext:(struct CGContext *)arg1 imageFrame:(struct CGRect)arg2;	// IMP=0x000000000062e089
- (id)visualRepresentationColor;	// IMP=0x000000000062de62
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000062ddc5
