...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x00100000006257b0
- (void).cxx_destruct;	// IMP=0x000000000062657d
...
- (id)takeSnapshot;	// IMP=0x0000000000625a0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006258e9
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x000000000062581c
