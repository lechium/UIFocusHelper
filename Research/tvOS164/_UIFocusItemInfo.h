...
+ (id)infoWithView:(id)arg1;	// IMP=0x00100000005fffd5
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x00100000005fff7b
+ (id)infoWithItem:(id)arg1;	// IMP=0x00100000005fff2d
- (void).cxx_destruct;	// IMP=0x00000000006012ed
...
- (id)description;	// IMP=0x0000000000601242
- (void)invalidateFocusedRegion;	// IMP=0x000000000060121c
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x000000000060115e
- (id)_createFocusedRegion;	// IMP=0x0000000000600454
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000600106
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x0000000000600024
