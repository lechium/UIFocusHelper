...
- (void).cxx_destruct;	// IMP=0x0000000000620382
...
- (void)_searchForFocusRegionsInContext:(id)arg1;	// IMP=0x0000000000620077
- (id)_preferredFocusRegionCoordinateSpace;	// IMP=0x000000000061ff54
@property(readonly, nonatomic) id <UIFocusItemContainer> focusItemContainer;
@property(readonly, nonatomic) __weak id <UIFocusEnvironment> parentFocusEnvironment;
- (void)updateFocusIfNeeded;	// IMP=0x000000000061feb5
- (void)setNeedsFocusUpdate;	// IMP=0x000000000061fe78
- (void)didUpdateFocusInContext:(id)arg1 withAnimationCoordinator:(id)arg2;	// IMP=0x000000000061fdf2
- (_Bool)shouldUpdateFocusInContext:(id)arg1;	// IMP=0x000000000061fd7b
@property(readonly, copy, nonatomic) NSArray *preferredFocusEnvironments;
@property(readonly, copy) NSString *description;
@property(readonly) unsigned long long hash;
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000000061fa77
- (id)_itemContainer;	// IMP=0x000000000061fa61
- (id)_owningEnvironment;	// IMP=0x000000000061fa4b
- (id)initWithEnvironmentContainer:(id)arg1;	// IMP=0x000000000061f95b
- (id)initWithOwningEnvironment:(id)arg1 itemContainer:(id)arg2;	// IMP=0x000000000061f901
