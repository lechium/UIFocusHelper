...
- (void).cxx_destruct;	// IMP=0x0000000000fd8c07
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace; // @synthesize coordinateSpace=_coordinateSpace;
- (id)visualDescription;	// IMP=0x0000000000fd89a9
- (id)description;	// IMP=0x0000000000fd8907
- (id)focusGroupForItem:(id)arg1;	// IMP=0x0000000000fd883d
...
- (id)_indexEnvironment:(id)arg1;	// IMP=0x0000000000fd7fc2
- (void)_indexItems:(id)arg1;	// IMP=0x0000000000fd7c51
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000fd795c
- (id)initWithItems:(id)arg1 standInItemsMap:(id)arg2 coordinateSpace:(id)arg3;	// IMP=0x0000000000fd770a
- (id)initWithItems:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x0000000000fd76f3
