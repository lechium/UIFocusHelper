...
- (void).cxx_destruct;	// IMP=0x00000000006603b0
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x000000000065ffe1
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x000000000065fbb0
