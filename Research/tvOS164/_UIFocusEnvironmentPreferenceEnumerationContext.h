...
- (void).cxx_destruct;	// IMP=0x00000000005fdc5c
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x00000000005fda82
- (void)_stopLogging;	// IMP=0x00000000005fda68
- (id)_startLogging;	// IMP=0x00000000005fd772
- (void)popEnvironment;	// IMP=0x00000000005fd657
- (void)pushEnvironment:(id)arg1;	// IMP=0x00000000005fd40c
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x00000000005fd3de
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x00000000005fd241
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x00000000005fcc55
- (void)_invalidatePreferredEnvironments;	// IMP=0x00000000005fcc2b
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x00000000005fc5cb
- (id)init;	// IMP=0x00000000005fc544
