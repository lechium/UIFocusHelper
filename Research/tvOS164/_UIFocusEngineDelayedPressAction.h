...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x0060000000618637
- (void).cxx_destruct;	// IMP=0x0000000000618a9e
...
- (void)_sendPressEvent;	// IMP=0x0000000000618729
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x000000000061853e
