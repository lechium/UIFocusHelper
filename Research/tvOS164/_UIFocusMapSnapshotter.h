...
- (void).cxx_destruct;	// IMP=0x000000000063cc1e
...
- (id)captureSnapshot;	// IMP=0x000000000063ca0b
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x000000000063c15c
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000063be51
- (id)init;	// IMP=0x000000000063bdca
