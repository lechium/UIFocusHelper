...
- (void).cxx_destruct;	// IMP=0x00000000006358a6
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x000000000063578c
- (void)addSnapshot:(id)arg1;	// IMP=0x0000000000635709
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x0000000000635600
