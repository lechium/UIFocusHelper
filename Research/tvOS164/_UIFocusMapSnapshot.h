...
- (void).cxx_destruct;	// IMP=0x000000000063b8a7
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x000000000063b633
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x000000000063a00a
- (void)addRegions:(id)arg1;	// IMP=0x0000000000639e44
- (void)addRegion:(id)arg1;	// IMP=0x000000000063997a
- (id)searchArea;	// IMP=0x0000000000639968
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
@property(readonly, nonatomic) __weak UIScreen *screen;
- (void)_capture;	// IMP=0x0000000000639413
@property(readonly, nonatomic) _Bool hasOnlyStaticContent;
- (void)markContainerAsProvidingDynamicContent;	// IMP=0x0000000000639299
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x0000000000639158
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x0000000000638f2f
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x0000000000638d24
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x0000000000638c0c
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000638b46
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x0000000000638a13
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x000000000063885a
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x00000000006385da
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x000000000063802c
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x0000000000637bf2
- (id)init;	// IMP=0x0000000000637b6b
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x000000000060af44
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x000000000060ae7f
