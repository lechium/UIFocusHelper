...
@interface _UIFocusEngineScrollableContainerOffsets : NSObject
{
    ...
    struct CGPoint _startContentOffset;	// 48 = 0x30
    struct CGPoint _lastContentOffset;	// 64 = 0x40
    struct CGPoint _lastRoundedOffset;	// 80 = 0x50
    struct CGPoint _targetContentOffset;	// 96 = 0x60
    struct CGPoint _lastVelocity;	// 112 = 0x70
}

- (void).cxx_destruct;	// IMP=0x0000000000669c2d
