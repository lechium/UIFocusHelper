...
- (void).cxx_destruct;	// IMP=0x000000000062d051
...
- (id)description;	// IMP=0x000000000062ceeb
...
- (id)_uniqueElementFromArray:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000062cbcb
- (void)_wasOccludedByFrame:(struct CGRect)arg1;	// IMP=0x000000000062caa3
- (id)sliceWithFrame:(struct CGRect)arg1;	// IMP=0x000000000062ca30
- (id)_mapEntriesByOccludingWithFrame:(struct CGRect)arg1;	// IMP=0x000000000062c3a0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000062c30b
- (id)initWithFrame:(struct CGRect)arg1 originalRegionFrame:(struct CGRect)arg2;	// IMP=0x000000000062c29c
