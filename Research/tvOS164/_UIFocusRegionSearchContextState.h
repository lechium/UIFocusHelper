...
+ (id)stateWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x006000000063ba21
- (void).cxx_destruct;	// IMP=0x000000000063bad4
...
- (id)initWithRegionContainer:(id)arg1 focusSystem:(id)arg2 clippingRect:(struct CGRect)arg3;	// IMP=0x000000000063b975
