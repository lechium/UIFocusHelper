...
- (void).cxx_destruct;	// IMP=0x000000000073e852
...
- (id)_requestByRedirectingRequestToFocusSystem:(id)arg1;	// IMP=0x000000000073e520
- (id)initWithFocusSystem:(id)arg1 window:(id)arg2;	// IMP=0x000000000073e417
- (id)init;	// IMP=0x000000000073e390
