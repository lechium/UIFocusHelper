...
- (void).cxx_destruct;	// IMP=0x00000000006e9485
...
- (void)_reportInferredPreferredFocusEnvironment:(id)arg1;	// IMP=0x00000000006e92ac
- (void)_stopLogging;	// IMP=0x00000000006e9292
- (id)_startLogging;	// IMP=0x00000000006e8fa0
- (void)popEnvironment;	// IMP=0x00000000006e8e85
- (void)pushEnvironment:(id)arg1;	// IMP=0x00000000006e8c38
- (_Bool)_isAllowedToPreferEnvironment:(id)arg1;	// IMP=0x00000000006e8c0a
- (id)_inferPreferencesForEnvironment:(id)arg1;	// IMP=0x00000000006e8a68
- (void)_resolvePreferredFocusEnvironments;	// IMP=0x00000000006e8470
- (void)_invalidatePreferredEnvironments;	// IMP=0x00000000006e8446
...
- (id)initWithFocusEnvironment:(id)arg1 enumerationMode:(long long)arg2;	// IMP=0x00000000006e7dea
- (id)init;	// IMP=0x00000000006e7d63
