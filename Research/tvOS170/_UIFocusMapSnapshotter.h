...
- (void).cxx_destruct;	// IMP=0x000000000072bf46
...
- (id)captureSnapshot;	// IMP=0x000000000072bd36
- (id)_searchAreaForContainerSearchRect:(struct CGRect)arg1;	// IMP=0x000000000072b468
- (id)initWithFocusSystem:(id)arg1 rootContainer:(id)arg2 coordinateSpace:(id)arg3 searchInfo:(id)arg4 ignoresRootContainerClippingRect:(_Bool)arg5;	// IMP=0x000000000072b15c
- (id)init;	// IMP=0x000000000072b0d5
