...
+ (id)combinedVisualRepresentationForSnapshots:(id)arg1 scaleFactor:(double)arg2;	// IMP=0x001000000071a6d7
- (void).cxx_destruct;	// IMP=0x000000000071b5b9
...
- (id)debugQuickLookObject;	// IMP=0x000000000071b3d3
- (id)visualRepresentationWithMinimumArea:(struct CGRect)arg1;	// IMP=0x000000000071942d
...
- (void)_didChooseFocusCandidateRegion:(id)arg1;	// IMP=0x0000000000718b9f
- (id)_snapshotByFulfillingPromiseFocusRegionEntry:(id)arg1;	// IMP=0x0000000000717f81
- (id)focusableRegionMapEntriesLimitedByFocusContainerGuide:(id)arg1;	// IMP=0x0000000000717c15
@property(readonly, copy, nonatomic) NSArray *allFocusableRegionMapEntries;
- (void)_commit;	// IMP=0x0000000000717bc3
- (void)_updateSortedFocusContainerGuideMapEntries;	// IMP=0x0000000000717b52
- (void)_updateFinalFocusableRegionMapEntries;	// IMP=0x0000000000717ab6
- (id)_sortedEligibleFocusContainerGuidesInArray:(id)arg1;	// IMP=0x0000000000717148
- (id)_finalFocusableRegionMapEntriesFromViewMapEntries:(id)arg1 guideMapEntries:(id)arg2;	// IMP=0x0000000000716e52
- (id)_finalFocusableRegionMapEntriesFromMapEntries:(id)arg1;	// IMP=0x000000000071682f
- (void)_punchHoleInMap:(id)arg1 atFrame:(struct CGRect)arg2;	// IMP=0x000000000071659f
- (void)_occludeFocusInFrame:(struct CGRect)arg1;	// IMP=0x00000000007164b8
- (void)_addFocusContainerGuide:(id)arg1 withFrame:(struct CGRect)arg2;	// IMP=0x000000000071635c
- (void)_addFocusableRegion:(id)arg1 isFocusGuide:(_Bool)arg2 withFrame:(struct CGRect)arg3;	// IMP=0x00000000007160b7
- (struct CGRect)_clippedRegionFrame:(struct CGRect)arg1 isFocusGuide:(_Bool)arg2;	// IMP=0x0000000000715e9d
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000715c68
- (id)_initWithRequest:(id)arg1;	// IMP=0x000000000071597c
