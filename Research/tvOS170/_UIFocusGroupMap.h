...
- (void).cxx_destruct;	// IMP=0x00000000011ea72f
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace; // @synthesize coordinateSpace=_coordinateSpace;
- (id)visualDescription;	// IMP=0x00000000011ea4cf
- (id)description;	// IMP=0x00000000011ea42d
- (id)focusGroupForItem:(id)arg1;	// IMP=0x00000000011ea361
...
- (id)_indexEnvironment:(id)arg1;	// IMP=0x00000000011e9af1
- (void)_indexItems:(id)arg1;	// IMP=0x00000000011e9782
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000011e9484
- (id)initWithItems:(id)arg1 standInItemsMap:(id)arg2 coordinateSpace:(id)arg3;	// IMP=0x00000000011e9227
- (id)initWithItems:(id)arg1 coordinateSpace:(id)arg2;	// IMP=0x00000000011e9210
