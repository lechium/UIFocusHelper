...
- (void).cxx_destruct;	// IMP=0x00000000006c9e13
...
- (void)_performDelayedFocusingAnimationIfNecessary;	// IMP=0x00000000006c9d26
- (void)_scheduleDelayedFocusingAnimationWithDelay:(double)arg1;	// IMP=0x00000000006c9c62
- (void)didUpdateFocusInContext:(id)arg1 fromItem:(id)arg2;	// IMP=0x00000000006c9714
- (id)willUpdateFocusInContext:(id)arg1;	// IMP=0x00000000006c9579
- (id)init;	// IMP=0x00000000006c950e
