...
+ (void)sendDelayedPressWithType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x00600000007057dd
- (void).cxx_destruct;	// IMP=0x0000000000705c17
...
- (void)_sendPressEvent;	// IMP=0x00000000007058cf
- (id)_initWithPressType:(long long)arg1 timestamp:(double)arg2 sender:(id)arg3;	// IMP=0x00000000007056e3
