...
@interface _UIFocusItemInfo : NSObject
{
    ...
    long long _rotaryFocusMovementAxis;	// 48 = 0x30
    _UIFocusRegion *_focusedRegion;	// 56 = 0x38
    id <UIFocusItem> _item;	// 64 = 0x40
    UIView *_containingView;	// 72 = 0x48
}

+ (id)infoWithView:(id)arg1;	// IMP=0x00100000006eb7e4
+ (id)infoWithItem:(id)arg1 useFallbackAncestorScroller:(_Bool)arg2;	// IMP=0x00100000006eb78b
+ (id)infoWithItem:(id)arg1;	// IMP=0x00100000006eb73d
- (void).cxx_destruct;	// IMP=0x00000000006ecc9b
...
- (id)shortDescription;	// IMP=0x00000000006ecad2
- (id)description;	// IMP=0x00000000006eca53
- (void)invalidateFocusedRegion;	// IMP=0x00000000006eca2d
- (struct CGRect)focusedRectInCoordinateSpace:(id)arg1;	// IMP=0x00000000006ec971
- (id)_createFocusedRegion;	// IMP=0x00000000006ebccd
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000000006eb91b
- (id)_initWithItem:(id)arg1 containingView:(id)arg2 useFallbackAncestorScroller:(_Bool)arg3;	// IMP=0x00000000006eb833
