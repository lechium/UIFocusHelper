...
- (void).cxx_destruct;	// IMP=0x00000000006e9d1e
...
- (_Bool)_shouldInferDefaultPreferenceForEnvironmentInContext:(id)arg1;	// IMP=0x00000000006e9c4d
- (void)enumeratePreferencesForEnvironment:(id)arg1 usingBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000000006e9563
- (id)initWithEnumerationMode:(long long)arg1;	// IMP=0x00000000006e9522
- (id)init;	// IMP=0x00000000006e950e
