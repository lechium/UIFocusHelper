...
- (void).cxx_destruct;	// IMP=0x0000000000751e3f
...
- (id)_trimEntries:(id)arg1 toFitCount:(long long)arg2;	// IMP=0x0000000000751a6c
- (id)entriesTrimmedToFitCount:(unsigned long long)arg1;	// IMP=0x0000000000751644
