...
+ (id)_summaryImageForDebugInfoArray:(id)arg1 forFocusMovementWithInfo:(id)arg2 scaleFactor:(double)arg3;	// IMP=0x00600000006f5e62
- (void).cxx_destruct;	// IMP=0x00000000006f6bc7
...
- (id)_drawImage;	// IMP=0x00000000006f52dd
- (struct CGRect)_rectContainingAllFocusRegions;	// IMP=0x00000000006f50e5
@property(readonly, nonatomic) struct CGPoint imageAnchorPoint; // @synthesize imageAnchorPoint=_imageAnchorPoint;
@property(readonly, nonatomic) UIImage *image; // @synthesize image=_image;
- (id)initWithSnapshot:(id)arg1 focusMapSearchInfo:(id)arg2;	// IMP=0x00000000006f4f60
