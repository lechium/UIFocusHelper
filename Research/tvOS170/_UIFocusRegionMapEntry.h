...
- (void).cxx_destruct;	// IMP=0x000000000071c41f
...
- (id)description;	// IMP=0x000000000071c2bd
...
- (id)_uniqueElementFromArray:(id)arg1 forKey:(id)arg2;	// IMP=0x000000000071bf8e
- (void)_wasOccludedByFrame:(struct CGRect)arg1;	// IMP=0x000000000071be66
- (id)sliceWithFrame:(struct CGRect)arg1;	// IMP=0x000000000071bdf3
- (id)_mapEntriesByOccludingWithFrame:(struct CGRect)arg1;	// IMP=0x000000000071b73b
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000000071b6aa
- (id)initWithFrame:(struct CGRect)arg1 originalRegionFrame:(struct CGRect)arg2;	// IMP=0x000000000071b63b
