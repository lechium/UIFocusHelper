...
- (void).cxx_destruct;	// IMP=0x0000000000724bea
...
- (void)addDestinationRegion:(id)arg1;	// IMP=0x0000000000724ad9
- (void)addSnapshot:(id)arg1;	// IMP=0x0000000000724a4f
@property(readonly, copy, nonatomic) NSArray *destinationRegions;
@property(readonly, copy, nonatomic) NSArray *snapshots;
- (id)init;	// IMP=0x0000000000724946
