...
+ (id)requestWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0010000000714b5c
- (void).cxx_destruct;	// IMP=0x000000000071594d
...
- (id)takeSnapshot;	// IMP=0x0000000000714dcc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000000714ca9
- (id)initWithRootView:(id)arg1 focusSystem:(id)arg2;	// IMP=0x0000000000714bca
