...
- (void).cxx_destruct;	// IMP=0x000000000072abb9
...
- (void)addRegionsInContainers:(id)arg1;	// IMP=0x000000000072a944
- (void)addRegionsInContainer:(id)arg1;	// IMP=0x0000000000729334
- (void)addRegions:(id)arg1;	// IMP=0x000000000072916d
- (void)addRegion:(id)arg1;	// IMP=0x0000000000728ca9
- (id)searchArea;	// IMP=0x0000000000728c97
@property(readonly, nonatomic) id <UICoordinateSpace> coordinateSpace;
@property(readonly, nonatomic) __weak UIScreen *screen;
- (void)_capture;	// IMP=0x000000000072873f
@property(readonly, nonatomic) _Bool hasOnlyStaticContent;
- (void)markContainerAsProvidingDynamicContent;	// IMP=0x00000000007285c6
- (struct CGRect)snapshotFrameForRegion:(id)arg1;	// IMP=0x0000000000728489
- (id)_cachedNextFocusedItemForRegion:(id)arg1 withFocusMovementRequest:(id)arg2 inMap:(id)arg3;	// IMP=0x0000000000728279
- (void)consumeRegionInformationForRegions:(id)arg1 fromSnapshot:(id)arg2;	// IMP=0x000000000072806a
- (id)occludingRegionsForRegion:(id)arg1;	// IMP=0x0000000000727f53
- (void)_trackOccludingRegion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000727e8f
- (id)originalRegionForRegion:(id)arg1;	// IMP=0x0000000000727d67
- (void)_trackSubregion:(id)arg1 forRegion:(id)arg2;	// IMP=0x0000000000727bad
- (id)regionsForOriginalRegion:(id)arg1;	// IMP=0x000000000072792f
@property(readonly, copy, nonatomic) NSArray *originalRegions;
@property(readonly, copy, nonatomic) NSArray *regions;
- (void)dealloc;	// IMP=0x0000000000727392
- (id)_initWithSnapshotter:(id)arg1 mapArea:(id)arg2 searchArea:(id)arg3;	// IMP=0x0000000000726f36
- (id)init;	// IMP=0x0000000000726eaf
- (id)_debugInfoWithFocusMapSearchInfo:(id)arg1;	// IMP=0x00000000006f6cbd
@property(readonly, nonatomic, getter=_debugInfo) _UIFocusMapSnapshotDebugInfo *debugInfo;
- (id)debugQuickLookObject;	// IMP=0x00000000006f6bf8
